...
class SparseSpikeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        inputs = {
            'X_ON': torch.zeros((7210, 7000)),
            'X_OFF': torch.zeros((7210, 7000)),
        }

        outputs = {
            'V1_Exc_L4': torch.zeros((7210, 37000)),
            'V1_Inh_L4': torch.zeros((7210, 9000)),
            'V1_Exc_L23': torch.zeros((7210, 37000)), 
            'V1_Inh_L23': torch.zeros((7210, 9000)), 
        }
